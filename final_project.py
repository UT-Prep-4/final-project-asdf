...
class Player(pygame.sprite.Sprite):
    COLOR = (255, 0, 0)
    GRAVITY = 1
    SPRITES = load_sprite_sheets("MainCharacter", "PinkMan", 32, 32, True)
    ANIMATION_DELAY = 3
...
def main(window):
    ...
    objects = [*floor, Block(100, HEIGHT - block_size * 2, block_size), 
               ...
               Block(block_size*19, HEIGHT-block_size*6, block_size),Block(block_size*20, HEIGHT-block_size*6, block_size)]
